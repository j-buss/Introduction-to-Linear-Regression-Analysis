...
#2.23
```{r}
rnorm(n = 20, mean = 0, sd = 16)
```
```{r}
data.frame(x=seq(from=1, to=10, by=0.5 ))
```

Extremely poorly worded problem. I am unclear if this is the ask, however I am going with this:
